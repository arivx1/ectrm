    ...
    <div className="start-here-overlay" role="presentation">
      ...
      >
        ...
        <div className="feedback-banner feedback-banner-success start-here-banner">
          {hasAuthSession
            ? `Signed in as ${authSession.user.display_name}. We will keep this out of the way after you choose a path for this session.`
            : 'Dismiss this if you already know where you are going. It will show again the next time you sign in.'}
        </div>
        ...
        <div className="start-here-footnote">
          <p>
            {hasAuthSession
              ? 'The overlay stays hidden for this session after you dismiss it or choose a job.'
              : 'The signed-out version stays hidden after dismissal, and the signed-in version will appear once after your next successful sign-in.'}
          </p>
        </div>
      </section>
    </div>
