...
export function useTradeAmendForm(
  ...
  return {
    ...
    amendConfirmationStatusInput: draft.confirmationStatusInput,
    setAmendConfirmationStatusInput: (value: string) => setDraftField('confirmationStatusInput', value),
    amendNominationStatusInput: draft.nominationStatusInput,
    setAmendNominationStatusInput: (value: string) => setDraftField('nominationStatusInput', value),
    amendAllocationStatusInput: draft.allocationStatusInput,
    setAmendAllocationStatusInput: (value: string) => setDraftField('allocationStatusInput', value),
    ...
    amendInvoiceStatusInput: draft.invoiceStatusInput,
    setAmendInvoiceStatusInput: (value: string) => setDraftField('invoiceStatusInput', value),
    amendPaymentStatusInput: draft.paymentStatusInput,
    setAmendPaymentStatusInput: (value: string) => setDraftField('paymentStatusInput', value),
