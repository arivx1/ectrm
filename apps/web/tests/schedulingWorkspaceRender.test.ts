...
import { SchedulingWorkspace } from '../src/workspaces/scheduling/SchedulingWorkspace'
...
test('scheduling workspace applies map-sourced rail-route focus before scheduler view filters', () => {
  const markup = renderToStaticMarkup(
    createElement(SchedulingWorkspace, {
      authSession: null,
      routeHandoff: {
        source: 'map',
        ...
        rationale:
          'This workspace started focused on the selected rail route so you can review the matching scheduling rows before widening back to the full board.',
      ...
      actualizationMutationPendingDeliveryId: null,
      workflowMutationError: '',
      workflowCreationPendingTradeId: null,
      workflowMutationPendingId: null,
      onCreateWorkflowItem: async () => undefined,
      onClearHandoff: () => undefined,
      onOpenTrade: () => undefined,
      onSaveActualization: async () => undefined,
      onSaveWorkflowItem: async () => undefined,
    }),
  )
