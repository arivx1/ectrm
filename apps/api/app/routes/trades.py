...
def list_trades(db: Session = Depends(get_db)) -> List[TradeOut]:
    ...
    return [
        TradeOut(
            ...
            quality_spec=r.quality_spec,
            unit_of_measure=r.unit_of_measure,
            trade_currency_code=r.trade_currency_code,
            location_code=r.location_code,
            delivery_start=r.delivery_start,
            delivery_end=r.delivery_end,
            price_unit_code=r.price_unit_code,
            instrument_type=r.instrument_type,
            option_type=r.option_type,
            option_style=r.option_style,
            option_strike_price=float(r.option_strike_price) if r.option_strike_price is not None else None,
            option_expiration_date=r.option_expiration_date,
