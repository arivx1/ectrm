...
class MessagingWorkspaceMessage(Base):
    ...
    parent_message_id: Mapped[Optional[str]] = mapped_column(String(64), nullable=True)
    thread_root_message_id: Mapped[Optional[str]] = mapped_column(String(64), nullable=True, index=True)
    ...
    edited_by_user_id: Mapped[Optional[str]] = mapped_column(String(128), nullable=True)
    edited_by_session_id: Mapped[Optional[str]] = mapped_column(String(128), nullable=True)
    edited_by_role: Mapped[Optional[str]] = mapped_column(String(64), nullable=True)
    deleted_at: Mapped[Optional[datetime]] = mapped_column(DateTime(timezone=True), nullable=True)
    deleted_by_user_id: Mapped[Optional[str]] = mapped_column(String(128), nullable=True)
    deleted_by_session_id: Mapped[Optional[str]] = mapped_column(String(128), nullable=True)
    deleted_by_role: Mapped[Optional[str]] = mapped_column(String(64), nullable=True)
    pinned_at: Mapped[Optional[datetime]] = mapped_column(DateTime(timezone=True), nullable=True)
    pinned_by_user_id: Mapped[Optional[str]] = mapped_column(String(128), nullable=True)
    pinned_by_session_id: Mapped[Optional[str]] = mapped_column(String(128), nullable=True)
    pinned_by_role: Mapped[Optional[str]] = mapped_column(String(64), nullable=True)
