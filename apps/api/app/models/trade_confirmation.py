...
class TradeConfirmation(Base):
    ...
    receipt_status: Mapped[str] = mapped_column(String(40), nullable=False, default="NOT_ISSUED")
    received_at: Mapped[Optional[datetime]] = mapped_column(DateTime(timezone=True), nullable=True)
    received_by: Mapped[Optional[str]] = mapped_column(String(128), nullable=True)
    response_method: Mapped[Optional[str]] = mapped_column(String(32), nullable=True)
    response_reference: Mapped[Optional[str]] = mapped_column(String(128), nullable=True)
