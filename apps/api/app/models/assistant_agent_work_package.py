...
class AssistantAgentWorkPackage(Base):
    ...
    implementation_evidence: Mapped[dict[str, object]] = mapped_column(JSON, nullable=False, default=dict)
    ...
    implemented_by: Mapped[str | None] = mapped_column(String(128), nullable=True)
