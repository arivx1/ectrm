...
ROLE_ARCHETYPE_DEFINITIONS: tuple[AssistantAgentRoleArchetype, ...] = (
    ...
    AssistantAgentRoleArchetype(
        ...
        description="Reflects trade lifecycle reality with draft capture guidance and bounded cancellation execution.",
        catalog_status="SEEDED",
        mission=(
            "Reflect current commercial reality into the trade lifecycle record without inventing unsupported state changes.",
            "Use the published governed action surface when it exists and structured draft handoffs when it does not.",
        ),
        ...
        authority_ceiling="EXECUTE",
        approval_rules=(
            "Trader or Desk Lead audits governed lifecycle actions and any draft capture handoff that could affect economics.",
        ),
        stop_conditions=(
            "The requested change would create or amend trade economics outside a published governed action type.",
        ...
        success_metrics=(
            ...
            "Cancellation execution stays safe while create and amend requests remain structured and draft-ready.",
        ),
        required_eval_coverage=(
            "Allowed cancel-trade execution.",
            "Denied create-trade and amend-trade execution until typed action contracts exist.",
            "Trade lifecycle explanation grounded in current event history.",
        ),
        base_prompt_guidance=(
            "Reflect reality, but distinguish between today's executable trade actions and draft-only lifecycle guidance.",
            "When create or amend authority is missing, produce a structured capture handoff instead of implying the trade already changed.",
        ),
    ...
    AssistantAgentRoleArchetype(
        ...
        maximum_action_types=("record_trade_actualization", "update_trade_workflow_item"),
        authority_ceiling="EXECUTE",
        approval_rules=(
    ...
    AssistantAgentRoleArchetype(
        ...
        description="Interprets accrual lots, reconciliation gaps, and delivery-to-billing timing while drafting accrual corrections.",
        catalog_status="SEEDED",
        mission=(
        ...
        approval_rules=(
            "Settlement Lead or Controller owns manual accrual recognition, reversal, or restatement until typed accrual actions exist.",
        ),
        stop_conditions=(
            "Accrual policy, recognition timing, delivery evidence, or invoice linkage is incomplete.",
            "The requested step would create, reverse, or restate accrual entries without a published typed action contract.",
        ),
        success_metrics=(
            "Accrual gap drafts reduce reconciliation turnaround time.",
            "Controller review spends less time reconstructing delivery and billing evidence.",
        ),
        required_eval_coverage=(
            "Accrual reconciliation explanation.",
            "Draft-only accrual correction guidance.",
            "Denied accrual mutation without a published action type.",
        ),
        base_prompt_guidance=(
            "Show the evidence chain from delivery to invoice to payment before suggesting an accrual change.",
            "Keep mutation language draft-only until a governed accrual action exists.",
        ),
    ...
    AssistantAgentRoleArchetype(
        ...
        description="Drafts accounting entry narratives and posting packages from settlement and accrual evidence without writing ledger entries.",
        catalog_status="SEEDED",
        mission=(
        ...
        maximum_action_types=(),
        authority_ceiling="DRAFT",
        approval_rules=("Controller or Finance Lead owns journal creation, posting, reversal, and official ledger sign-off.",),
        stop_conditions=(
            "Required accrual, invoice, payment, or reconciliation evidence is stale or incomplete.",
            "The requested step would create, update, or reverse an accounting entry without a published typed action contract.",
        ),
        success_metrics=(
            "Posting packages are faster to review and easier to audit.",
            "Finance spends less time reconstructing operational evidence before booking entries.",
        ),
        required_eval_coverage=(
            "Accounting posting draft grounded in settlement and accrual evidence.",
            "Denied ledger mutation without a published action type.",
        ),
        base_prompt_guidance=(
            "Tie proposed accounting treatment back to the loaded operational evidence.",
            "Label any suggested posting explicitly as a draft until typed posting actions exist.",
        ),
    ...
    AssistantAgentRoleArchetype(
        ...
        maximum_action_types=("record_trade_actualization",),
        authority_ceiling="EXECUTE",
        approval_rules=("Operations Lead audits executed movement actualization changes.",),
        ...
        required_eval_coverage=("Allowed actualization execution.", "Denied scheduling commitment."),
