...
def serialize_agent_revision_payload(record: AssistantAgent) -> dict[str, Any]:
    return {
        ...
        "orchestration_pattern": record.orchestration_pattern,
...
def normalize_agent_revision_payload(payload: Mapping[str, Any]) -> dict[str, Any]:
    return {
        ...
        "orchestration_pattern": payload.get("orchestration_pattern") or "SINGLE",
        "parent_agent_id": payload.get("parent_agent_id"),
        "managed_agent_ids": [str(value) for value in list(payload.get("managed_agent_ids") or [])],
        "delegation_guidance": payload.get("delegation_guidance"),
