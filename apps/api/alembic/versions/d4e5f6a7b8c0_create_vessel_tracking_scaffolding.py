...
def upgrade() -> None:
    ...
    op.add_column("delivery_tracking_signals", sa.Column("speed_knots", sa.Numeric(precision=7, scale=3), nullable=True))
    op.add_column(
    ...
    op.add_column("delivery_tracking_signals", sa.Column("draught_meters", sa.Numeric(precision=7, scale=3), nullable=True))
    op.add_column("delivery_tracking_signals", sa.Column("destination", sa.String(length=120), nullable=True))
    op.add_column("delivery_tracking_signals", sa.Column("eta_at_destination", sa.DateTime(timezone=True), nullable=True))
